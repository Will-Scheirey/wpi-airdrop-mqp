% PLEASE NOTE: This function was generated by ChatGPT. It was reviewed
% briefly and works properly for our usecase, but the handling of various
% format cases may not be correct
% 
% Since the Flysight data is not in standard .csv format, the plain text 
% must be processed line-by-line.
